...
param_grid = {
    ...
    "macd_signal": [10, 9],
    "rsi_period": [14],
    "max_risk_pct": [0.05, 0.1, 0.15, 0.2],
    "trailing_multiplier": [1.5, 1.8, 2.0, 2.5],
    "profit_target_atr_multiple": [1.5, 2.0, 2.5],
...
for params in grid:
    ...
    config = ESVIXStrategyConfig(
        ...
        vix_ma_period=20,  # fixed for this grid
        max_risk_pct=params["max_risk_pct"],
        trailing_multiplier=params["trailing_multiplier"],
        trailing_atr_period=14,
        bars_required=50,
        bars_threshold=params["bars_threshold"],
        profit_target_atr_multiple=params["profit_target_atr_multiple"],
